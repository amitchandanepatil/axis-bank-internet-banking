...
//        return "918020" + (100000 + random.nextInt(900000));
//    }
//
//    // REGISTER (FIXED)
...
//                    customerRepository.findByAccountNumber(request.getAccountNumber());
//
...
//
//            // IMPORTANT FIX: do NOT use request account number
...
//            account.setBranchName("Pune Main Branch");
//            account.setIfscCode("UTIB0000001");
//            account.setBalance(5000.0);
//
//            accountRepository.save(account);
//
//            return "Registration Successful. Your Customer ID: " + customerId;
//
//        } catch (Exception e) {
